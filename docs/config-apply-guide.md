...
First, download your desired config file and save it locally to your device. Make sure to remember which folder it was saved to (this is usually your default _Downloads_ folder).
