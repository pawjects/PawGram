...
Need help with PawGram? Here is how you can get support from the PawDevs team and our community:
...
*   [How to apply Metaconfigs (Config Apply)](dev/ConfigApplyGuide.md)
*   [Frequently Asked Questions](docs/FAQ.md)

## 3. Submitting Bug Reports
If you have found a reproducible bug (e.g., issues with AMOLED theming, iOS emojis not rendering, or ad-blocker failures), please open a Bug Report via the GitHub Issues tab. 

When submitting an issue, provide as much detail as possible, including:
*   Device model and OS version
*   Base app version
*   Current PawGram version
